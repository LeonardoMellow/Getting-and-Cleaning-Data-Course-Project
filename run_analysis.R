...
# READING THE INDEPENDENT VARIABLES FROM TRAINING AND TEST SETS:
...
# READING THE DEPENDENT VARIABLE FROM TRAINING AND TEST SETS:
...
# BINDING ROWS FROM TRAINING AND TEST SETS:
...
# JOINING THE DEPENDENT VARIABLE WITH THE ACTIVITY LABEL:
